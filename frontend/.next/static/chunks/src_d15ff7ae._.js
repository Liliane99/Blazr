...
function Inbox() {
    ...
    const [newChatParticipants, setNewChatParticipants] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
                    ...
                    setChats({
                        "Inbox.useEffect": (prevChats)=>{
                            const updatedChats = prevChats.map({
                                "Inbox.useEffect.updatedChats": (chat)=>chat.id === selectedChat.id ? {
                                        ...chat,
                                        lastMessage: {
    ...
    const handleSend = ()=>{
        ...
        setChats((prevChats)=>{
            const updatedChats = prevChats.map((chat)=>chat.id === selectedChat.id ? {
                    ...chat,
                    lastMessage: {
                        content: newMessage,
                        timestamp,
    ...
    const handleCreateChat = async ()=>{
        ...
        const res = await fetch(`${API_URL}/chats`, {
            ...
            body: JSON.stringify({
                ...
                participantUsernames: newChatParticipants.split(",").map((u)=>u.trim()).filter((u)=>u.length > 0)
            })
        });
        if (!res.ok) return;
        const data = await res.json();
    ...
    const truncateMessage = (message, maxLength = 50)=>message.length > maxLength ? `${message.substring(0, maxLength)}...` : message;
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col sm:flex-row h-screen overflow-hidden bg-gray-100 text-gray-900",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full sm:w-16 shrink-0 bg-white border-b sm:border-r sm:border-b-0",
...
_s(Inbox, "sWz/57gHAUbj0Q4+wOicr71XkA0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_d15ff7ae._.js.map